<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ParentStudentLastNews.ascx.cs"
...
<div class="PanelContainer">
    ...
    <div class="PanelContainerBody">
        <span class="PanelContainerBodySpan">آخرین اخبار و وقایع</span>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:Image ID="Image1" Style="margin-left: 0px;" ImageUrl="~/Images/mosbat-abi.gif"
                            runat="server" />
                        <a style="font-size: 9pt" href='<%#"./index.aspx?Type=Content"+Request.Cookies["Type_Role"].Value.ToString()+"&ID_Content=" +Eval("Content_ID").ToString() %>'>
