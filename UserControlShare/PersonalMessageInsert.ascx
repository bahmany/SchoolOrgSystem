<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonalMessageInsert.ascx.cs"
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">ارسال پیغام شخصی</asp:Label></span>
        <div style="margin-right: 20px; margin-left: 10px;">
            <span class="SpanHelp">شما در این بخش میتوانید به کاربر مورد نظر خود پیغام شخصی بفرستید:
            </span>
            <br />
            <br />
            <p>
