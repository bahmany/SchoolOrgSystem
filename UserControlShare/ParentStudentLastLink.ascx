<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ParentStudentLastLink.ascx.cs" Inherits="UserControlPublic_LastBreak" %>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:Image ID="Image1" Style="margin-left: 0px;" ImageUrl="~/Images/mosbat-abi.gif"
                            runat="server" />
                        <a style="font-size: 9pt" href='<%# Eval("LI_Link") %>'> <%# Eval("LI_Title").ToString() %></a>
                        <br />
