...
public partial class UserControlPublic_AdminInformationAdd : System.Web.UI.UserControl
{
    ...
    private void FillGrid()
    {
            ...
            GridView1.DataSource = new tbl_PersonalMessageTableAdapter().GetDataByOutbox(
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        if (bool.Parse(((Label)(GridView1.Rows[e.RowIndex].FindControl("lblDelete_Getter"))).Text))
        {
            new tbl_PersonalMessageTableAdapter().Delete(ID);
        }
        else
        {
            new tbl_PersonalMessageTableAdapter().UpdateDeleteSender(ID);
        }
        FillGrid();
