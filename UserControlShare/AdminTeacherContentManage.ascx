<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminTeacherContentManage.ascx.cs"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="عنوان">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("Con_Title").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="در تاریخ">
                                <ItemTemplate>
                                    
                                    <asp:Label ID="lblDatecon" runat="server" Text='<%# Eval("Con_Date") %>' ></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href='<%# "./Index.aspx?Type=ContentEdit"+"&Content_ID="+ Eval("Content_ID").ToString()+"&TypeContent="+Eval("Con_Type").ToString() %>'>
