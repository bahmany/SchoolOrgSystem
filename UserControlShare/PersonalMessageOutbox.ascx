<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonalMessageOutbox.ascx.cs"
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">پیام های فرستاده شده</span>
        <div style="margin-right: 30px; margin-left: 30px;">
            <span class="SpanHelp">در این قسمت میتوانید پیام های ارسالی خود را مشاهده و مدیریت نمایید :
            </span>
            <br />
            <br />
            <br />
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="عنوان">
                        <ItemTemplate>
                        <a href="index.aspx?Type=PersonalMessageDetail&Kind=Outbox&ID_PersonalMessage=<%# Eval("Personal_Message_ID") %>"><%# Eval("PM_Title").ToString() %> </a>
                            <asp:Label ID="lblID" runat="server" Text='<%# Eval("Personal_Message_ID") %>' Visible="False"></asp:Label>
                            <asp:Label ID="lblTypeGetter" runat="server" Text='<%# Eval("PM_Type_Role_Getter") %>' Visible="False"></asp:Label>
                            <asp:Label ID="lblIDGetter" runat="server" Text='<%# Eval("PM_ID_Role_Getter") %>' Visible="False"></asp:Label>
                     ...
                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="فرستاده شده به">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="تاریخ ارسال">
                      ...
                      <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="مشاهده">
                        <ItemTemplate>
                            <asp:CheckBox Enabled=false ID="CheckBox1" Checked='<%# bool.Parse(Eval("PM_Vision").ToString()) %>' runat="server" />
