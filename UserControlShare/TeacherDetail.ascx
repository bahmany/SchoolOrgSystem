<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TeacherDetail.ascx.cs"
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">مشاهده مشخصات فردی معلم</span>
        ...
        <div style="margin-right: 70px;float:right;width:300px" >
            <span class="SpanNormal">نام و نام خانوادگی :</span>
             <span class="SpanNormalShow"><%=TextName%></span>
            <br />
            <br />
            
           <span class="SpanNormal">نام کاربری :</span>
            <span class="SpanNormalShow"><%=TextUserName%></span>
            <br /><br />
            
            <span class="SpanNormal">تاریخ عضویت :</span>
            <span class="SpanNormalShow"><%=TextStartTime%></span>
            <br /><br />
            <span class="SpanNormal">آخرین بازدید :</span>
            <span class="SpanNormalShow"><%=TextEndTime%></span>
            <br /><br />
        ...
        <asp:Image  ID="Image1" runat="server" BorderColor="Black"
            BorderStyle="Solid" BorderWidth="1px" Height="100px" Width="100px"  />
