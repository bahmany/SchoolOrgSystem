...
public partial class UserControlPublic_AdminInformationAdd : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (i == 0)
        {
            if (!IsPostBack)
            {
                ...
                if (TypeContent == "News")
                {
                    Label1.Text = "مدیریت اخبار و اطلاعیه ها";
                    Label2.Text = "در این قسمت میتوانید اخبار و اطلاعیه ها را مدیریت نمایید : ";
                }
                else if (TypeContent == "Library")
                {
                    Label1.Text = "مدیریت کتابخانه و مقالات";
                    Label2.Text = "در این قسمت میتوانید کتابخانه و مقالات را مدیریت نمایید: ";
                }
                else if (TypeContent == "Break")
                {
                    Label1.Text = "مدیریت زنگ تفریح ";
                    Label2.Text = "در این قسمت میتوانید زنگ تفریح را مدیریت نمایید : ";
                }
            }
        }
    }
    ...
    private void FillGrid()
    {
        ...
        if (Request.Cookies["Type_Role"].Value.ToString() == "Admin")
        {
            ...
            GridView1.DataSource = new tbl_ContentTableAdapter().GetDataByCon_TypeAndCategory_ID(Request.QueryString["TypeContent"].ToString(), ID_Category);
            GridView1.DataBind();
        ...
        else if (Request.Cookies["Type_Role"].Value.ToString() == "Teacher")
        {
            ...
            GridView1.SelectedIndex = -1;
            GridView1.DataSource = new tbl_ContentTableAdapter().GetDataByCategory_IDAndCon_ID_RoleAndCon_Type(
                int.Parse(Request.Cookies["ID_Role"].Value.ToString()), Request.QueryString["TypeContent"].ToString(),
                Request.Cookies["Type_Role"].Value.ToString(), ID_Category);
            GridView1.DataBind();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        new tbl_ContentTableAdapter().Delete(ID);
        FillGrid();
