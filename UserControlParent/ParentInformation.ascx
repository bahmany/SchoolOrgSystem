...
<div class="PanelContainerBig">
    ...
    <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">ویرایش اطلاعات شخصی</span>
<div style="margin-right: 30px;margin-left:30px;">
        ...
        <asp:Button ID="Button3" runat="server" CssClass="ButtonNormal" Text="ویرایش" ValidationGroup="Register"
