<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LastGalleryArchive.ascx.cs" Inherits="UserControlPublic_LastBook" %>
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig">گالری تصاویر </span>
         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CssClass="GridBox" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging"
            OnRowDataBound="GridView1_RowDataBound" ShowHeader="False" Width="594px" PageSize="5">
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:Image ID="Image1" Style="margin-left: 0px;" ImageUrl="~/Images/mosbat-abi.gif"
                            runat="server" />
                        <a style="font-size: 9pt" href='<%#"./index.aspx?Type=GalleryDetailPublic&ID_GallerySubject=" + Eval("GallerySubjet_ID").ToString() %>'>
