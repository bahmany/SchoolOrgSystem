<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LastNewsArchive.ascx.cs" Inherits="UserControlPublic_LastNews" %>
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig">آخرین اخبار و وقایع</span>
