...
public partial class UserControlPublic_LastNews : System.Web.UI.UserControl
{
    ...
    private void FillGrid()
    {
        int ID_Category = -10;
            ...
            GridView1.DataSource = new tbl_ContentTableAdapter().GetDataByCon_TypeAndCon_ID_CategoryPublic("News",ID_Category);
            GridView1.DataBind();
