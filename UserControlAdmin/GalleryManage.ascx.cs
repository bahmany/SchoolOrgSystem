...
public partial class UserControlPublic_AdminInformationAdd : System.Web.UI.UserControl
{
    ...
    private void FillGrid()
    {
        ...
        GridView1.DataSource = new tbl_GallerySubjectTableAdapter().GetDataByID_CategoryID_Admin( int.Parse(Request.Cookies["ID_Role"].Value),ID_Category);
        GridView1.DataBind();
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowIndex != -1)
        {
            ...
            DataTable dt = new tbl_GalleryPictureTableAdapter().GetDataBygp_ID_GallerySubject(ID);

            ((Label)(e.Row.FindControl("lblCount"))).Text = dt.Rows.Count.ToString();
        }
    }
}
