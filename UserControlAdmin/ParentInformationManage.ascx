<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ParentInformationManage.ascx.cs"
    ...
    <ContentTemplate>
        <div class="PanelContainerBig">
            ...
            <div class="PanelContainerBodyBig">
                <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">مدیریت والدین</span>
                <div style="margin-right: 30px; margin-left: 30px;">
                    <span class="SpanHelp">در این قسمت میتوانید اولیاء را مدیریت نمایید : </span>
                    <br />
                    <br />
                </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="نام فرزند">
                                <ItemTemplate>
                                    <asp:Label ID="Labelnamechild" runat="server" Text='<%# Eval("SI_Name").ToString() %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="نام کاربری فرزند">
                                <ItemTemplate>
                                    <asp:Label ID="Labeluserchild" runat="server" Text='<%# Eval("SI_UserName").ToString() %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href='<%# "./Index.aspx?Type=AdminParentEdit&Parent_ID="+ Eval("Parent_ID").ToString()%>'>
