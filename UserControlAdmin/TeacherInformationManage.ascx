<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TeacherInformationManage.ascx.cs"
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">مدیریت معلم ها</span>
        <div style="margin-right: 30px; margin-left: 30px;">
            <span class="SpanHelp">در این قسمت میتوانید معلم ها را ایجاد و مدیریت نمایید :
            </span>
            <br />
            <br />
        ...
        <div style="margin-right: 100px;">
            ...
            <br />
            <span class="SpanNormal">نام پدر :</span><asp:TextBox CssClass="TextBoxNormal" ID="TextFatherName"
                runat="server"></asp:TextBox>
            <br />
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="نام و نام خانوادگی">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%# Eval("Teacher_ID") %>' Visible="False"></asp:Label>
