<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubTitleManage.ascx.cs"
...
<div class="PanelContainerBig">
    ...
    <div class="PanelContainerBodyBig">
        <span class="PanelContainerBodySpanBig" style="margin-bottom: 20px;">مدیریت پیام های زیرنویس</span>
        <div style="margin-right: 30px;margin-left:30px;">
             <span class="SpanHelp" >در این قسمت پیام های زیرنویس را میتوانید مدیریت کنید  : </span>
        <br /><br /><br /><br />
        </div>
        <div style="margin-right:95px; ">
        <span class="SpanNormal">عنوان</span><asp:TextBox TextMode=MultiLine ID="TextTitle" CssClass="TextBoxNormal"  runat="server"
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:TemplateField HeaderText="متن">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("SB_Title") %>'></asp:Label>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("SubTitle_ID") %>' Visible="False"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server"  TextMode=MultiLine CssClass="FieldInputOneLine" 
                            Text='<%# Eval("SB_Title") %>'></asp:TextBox>
                        <asp:Label ID="lblID0" runat="server" Text='<%# Eval("SubTitle_ID") %>' Visible="False"></asp:Label>
                    </EditItemTemplate>
